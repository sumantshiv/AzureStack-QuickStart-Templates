    ...
    Node localhost {
        Script InstallServiceFabric
        {
            ...
            SetScript = 
            {
                ...
                $diagStoreConnectinString = "xstore:DefaultEndpointsProtocol=https;AccountName=$Using:DiagStoreAccountName;AccountKey=$Using:DiagStoreAccountKey;EndpointPrefix=$Using:dnsSuffix"
